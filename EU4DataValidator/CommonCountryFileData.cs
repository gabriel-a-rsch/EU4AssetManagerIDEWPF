...
namespace EU4DataValidator
{
    internal class CommonCountryFileData
    {
        ...
        public required string TAG { get; set; } // should be a 3-letter code, but we can use a string for flexibility. can be taken from the filename
        public required string Name { get; set; } // can be taken from the filename
        ...
        public required (int,int,int) color { get; set; } // RGB color values, should be a tuple of three integers, I should technically do bounds checking here, the range is 0-255 for each value
